...
<Card title="Conditional Logic" icon="brackets-curly" href="/built-in-nodes/core-function">
  Use with scripts and validators
</Card>

<Card title="Send Data to Apps" icon="plug" href="/built-in-nodes/apps">
  Push filtered or looped data to external services
</Card>

<Card title="Use in Loops" icon="flowchart" href="/workflows/passing-data">
  Pass and reference loop variables
</Card>
