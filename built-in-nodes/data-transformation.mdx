...
<Card title="Script Logic" icon="brackets-curly" href="/built-in-nodes/core-function">
  For custom JS-based logic
</Card>

<Card title="Pass Data" icon="arrow-right" href="/workflows/passing-data">
  Use transformed values downstream
</Card>

<Card title="Filter/Loop" icon="flowchart" href="/built-in-nodes/data-flow">
  Combine with control nodes
</Card>
