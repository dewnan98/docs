...
<Card title="Use Script Logic" icon="brackets-curly" href="/built-in-nodes/data-transformation">
  Add JS where transformations fall short
</Card>

<Card title="Trigger with Webhook" icon="alarm-clock" href="/built-in-nodes/trigger">
  Use Respond node after external call
</Card>

<Card title="Reusable Flows" icon="flowchart" href="/workflows/building-workflow">
  Call flows from other flows with Execute Node
</Card>
