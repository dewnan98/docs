...
<Card title="Build AI Flows" icon="flowchart" href="/workflows/building-workflow">
  Add AI logic to your workflows
</Card>

<Card title="Connect Apps" icon="plug" href="/built-in-nodes/apps">
  Send AI output to external services
</Card>

<Card title="Use Core Nodes" icon="brackets-curly" href="/built-in-nodes/core-function">
  Combine AI with logic and control nodes
</Card>
